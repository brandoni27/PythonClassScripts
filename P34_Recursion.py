...
# 5/11/2019
# Python 3.6
# Description: Sings beer song wih recursion.
...
def recursiveBeer(n):
    if n == 0:
        ...
        print(n, 'bottles of beer on the wall. ', n, ' bottles of beer. You take one down, pass it around. ', n - 1,
...
'''
/Library/Frameworks/Python.framework/Versions/3.6/bin/python3.6 "/Users/Brando/Desktop/Python Code/P34_Recursion.py"
